...
function Set-12111BasicStoragePin {
    param($Row)
    $url = 'https://github.com/survivorsunited/mod-basic-storage/releases/download/2.0.33/basic-storage-2.0.33+1.21.11.jar'
    $Row.CurrentGameVersion = '1.21.11'
    $Row.CurrentVersion = '2.0.33'
    $Row.CurrentVersionUrl = $url
    $Row.Jar = 'basic-storage-2.0.33+1.21.11.jar'
    $Row.LatestGameVersion = '1.21.11'
    $Row.LatestVersion = '2.0.33'
