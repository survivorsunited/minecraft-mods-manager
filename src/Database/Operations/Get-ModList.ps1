# =============================================================================
# Mod List Database Operations Module
# =============================================================================
# This module handles loading and managing mod lists from CSV files.
# =============================================================================

<#
.SYNOPSIS
    Loads mod list from CSV file.

.DESCRIPTION
    Loads mod list from CSV file with integrity verification and
...
.EXAMPLE
    Get-ModList -CsvPath "modlist.csv"

.NOTES
    - Ensures CSV has required columns
    - Adds RecordHash to records that don't have it
    - Verifies record integrity
    - Detects and handles external changes
#>
