...
# =============================================================================
# This module handles generation of backup file paths.
# =============================================================================
...
.PARAMETER OriginalPath
    The original file path to create backup for.

.PARAMETER BackupType
    The type of backup (default: "backup").

.EXAMPLE
    Get-BackupPath -OriginalPath "modlist.csv" -BackupType "columns"

.NOTES
    - Creates backups folder if it doesn't exist
    - Uses timestamp for unique backup names
