...
$testModList = @(
    [PSCustomObject]@{
        ...
        VersionUrl = "https://github.com/FabricMC/fabric/releases/download/0.127.1%2B1.21.6/fabric-api-0.127.1+1.21.6.jar"
        LatestVersionUrl = "https://github.com/FabricMC/fabric/releases/download/0.127.1%2B1.21.6/fabric-api-0.127.1+1.21.6.jar"
        ApiSource = "modrinth"
        Host = "modrinth.com"
        Title = "Fabric API"
