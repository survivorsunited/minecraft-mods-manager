# DownloadLatestMods.ps1
# Downloads latest versions of all mods
# 
# This script downloads the latest versions of all mods without server testing:
# 1. Update mod database to latest versions
# 2. Download latest mods
#
# Usage: .\scripts\DownloadLatestMods.ps1 [-DownloadFolder "path"] [-DatabaseFile "path"]
...
# Main execution
Write-Header "Downloading Latest Mod Versions"
Write-Host "This script will download the latest versions of all mods." -ForegroundColor $Colors.Info
...
# Summary
Write-Header "Latest Mods Download Complete"
Write-Host "Download Folder: $DownloadFolder" -ForegroundColor $Colors.Info
Write-Host "Database File: $DatabaseFile" -ForegroundColor $Colors.Info
...
Write-Host "2. To test server compatibility, run: .\scripts\TestLatestMods.ps1" -ForegroundColor $Colors.Info

Write-Success "Latest mods download completed!" 